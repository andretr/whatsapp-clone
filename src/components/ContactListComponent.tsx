...
const ContactComponent =(props: { userData: any; }) => {
    ...
    return (
        <div className='flex flex-row px-3 py-4 cursor-pointer bg-white border-b-2 border-solid border-b-[#f2f2f2]'>
            ...
            <div className='flex flex-col w-full my-0 mx-5'>
                ...
                <span className='w-full text-sm mt-1 text-[#000000cc]'>{userData.lastText}</span>
            </div>
            <span className='w-1/3 text-sm mt-1 text-[#000000cc]'>{userData.lastTextTime}</span>
        </div>
    );
};
